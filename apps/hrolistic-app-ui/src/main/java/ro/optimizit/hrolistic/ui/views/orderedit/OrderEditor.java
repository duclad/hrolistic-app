package ro.optimizit.hrolistic.ui.views.orderedit;

import static ro.optimizit.hrolistic.ui.dataproviders.DataProviderUtil.createItemLabelGenerator;
...
import ro.optimizit.hrolistic.backend.data.OrderState;
import ro.optimizit.hrolistic.backend.data.entity.Order;
import ro.optimizit.hrolistic.backend.data.entity.PickupLocation;
import ro.optimizit.hrolistic.backend.data.entity.Product;
import ro.optimizit.hrolistic.backend.data.entity.User;
import ro.optimizit.hrolistic.backend.service.PickupLocationService;
import ro.optimizit.hrolistic.backend.service.ProductService;
import ro.optimizit.hrolistic.ui.crud.CrudEntityDataProvider;
import ro.optimizit.hrolistic.ui.dataproviders.DataProviderUtil;
import ro.optimizit.hrolistic.ui.events.CancelEvent;
import ro.optimizit.hrolistic.ui.utils.FormattingUtils;
import ro.optimizit.hrolistic.ui.utils.converters.LocalTimeConverter;
import ro.optimizit.hrolistic.ui.views.storefront.events.ReviewEvent;
import ro.optimizit.hrolistic.ui.views.storefront.events.ValueChangeEvent;
